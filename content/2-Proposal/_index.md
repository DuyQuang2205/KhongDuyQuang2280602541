...
### Access the PetCare Shop Application

The PetCare Shop platform is now deployed and accessible through Amazon CloudFront:

🔗 **Live Demo:** [https://d2x5ledabb9h2k.cloudfront.net/](https://d2x5ledabb9h2k.cloudfront.net/)

You can explore the application features, browse products, and test the pet care booking functionality through this live deployment.